...
async function pegaArquivo(caminhoDoArquivo) {
  try {
    ...
    const texto = await fs.promises.readFile(caminhoDoArquivo, encoding) // lê o arquivo e joga na variável textp
    return extraiLinks(texto); // extrai os links e os títulos da string texto
  } catch (erro) {
    trataErro(erro)
  } finally {
